# AI CLI Gateway v0.2.2 API and Operations Reference

Detailed contracts and operating boundaries for AI CLI Gateway v0.2.2. For installation and a first request, start with [Getting Started](getting-started.md).

...
func TestRunRejectsEachNilFunctionDependencyWithoutInvokingAnything(t *testing.T) {
	tests := []struct {
		...
		{"LookupExecutable", func(value *Dependencies) { value.LookupExecutable = nil }},
	...
	for _, test := range tests {
		t.Run(test.name, func(t *testing.T) {
			...
			dependencies := Dependencies{
				...
				LookupExecutable: func(string) (string, error) { calls++; return "", nil },
...
func TestRunResolvesUnixNodeLauncherBeforeProbe(t *testing.T) {
	if runtime.GOOS == "windows" {
		t.Skip("Unix launcher fixture; native Windows launcher coverage is separate")
	}
	fixture := newUnixNodeLauncherFixture(t, "\n")
